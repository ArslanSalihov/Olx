...
def index(request):
    ...
    return render(request,'olx_app/index.html')

def c_product(request):
    product = Product.objects.all()
    return render(request,'olx_app/c_product.html')
...
def delete_post(request,id):
    ...
    return render(request, 'olx_app/delete.html',{'product':product})
...
def product_detail(request):
    product = Product.objects.all()
    return render(request,'olx_app/product_detail.html')

def category_detail(request):
    category = Category.objects.all()
    product = Product.objects.all()
    return render(request, 'olx_app/category_detail.html',{'category':category})

def search(request):
    quary = request.GET.get('search')
    search_obj= Product.objects.filter(Q(title__contains=quary))
